...
<head>
    ...
    <title>PT. Windu Expotindo </title>

    <link rel="stylesheet" href="static/assets/frontend/css/bootstrap.min.css">
    <link rel="stylesheet" href="static/assets/frontend/css/line-icons.css">
    <link rel="stylesheet" href="static/assets/frontend/css/owl.carousel.css">
    <link rel="stylesheet" href="static/assets/frontend/css/owl.theme.css">
    <link rel="stylesheet" href="static/assets/frontend/css/nivo-lightbox.css">
    ...
    <!-- <link rel="stylesheet" href="static/assets/frontend/css/color-switcher.css"> -->
    <link rel="stylesheet" href="static/assets/frontend/css/menu_sideslide.css">
    <link rel="stylesheet" href="static/assets/frontend/css/main.css">
...
<body>
    ...
    <header id="home" class="hero-area">
        <nav class="navbar navbar-expand-md fixed-top scrolling-navbar">
            <div class="container">
                <a class="navbar-brand" href="index-2.html"><span class="lni-bulb"></span>PT. Windu Expotindo</a>
...
<!--                         <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link page-scroll" href="<?php echo site_url('login') ?>">Login</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row space-100">
                <div class="col-lg-7 col-md-12 col-xs-12">
                    <div class="contents">
                        <h2 class="head-title">An Example of<br> Product Landing Page</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officiis assumenda eius, quibusdam eum voluptatum a enim magni, cupiditate accusamus dolorem voluptates.</p>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officiis assumenda eius, quibusdam eum voluptatum a enim magni, cupiditate accusamus dolorem voluptates.</p>
                        <div class="header-button">
                            <a href="#" class="btn btn-common btn-effect">Purchase</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5 col-md-12 col-xs-12">
                    <div class="intro-img">
                        <img src="static/assets/frontend/img/intro.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-10">
                    <div class="cta-trial text-center">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod
                            <br> Lorem ipsum dolor sit amet, consectetuer</p>
...
Print
            ...
            <div id="portfolio" class="row">
                <div class="col-lg-4 col-md-6 col-xs-12 mix development print">
                    <div class="portfolio-item">
                        <div class="shot-item">
                            <img src="static/assets/frontend/img/portfolio/img-1.jpg" alt="" />
                            <div class="single-content">
                                <div class="fancy-table">
                                    <div class="table-cell">
                                        <div class="zoom-icon">
                                            <a class="lightbox" href="static/assets/frontend/img/portfolio/img-1.jpg"><i class="lni-zoom-in item-icon"></i></a>
                                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-xs-12 mix design print">
                    <div class="portfolio-item">
                        <div class="shot-item">
                            <img src="static/assets/frontend/img/portfolio/img-2.jpg" alt="" />
                            <div class="single-content">
                                <div class="fancy-table">
                                    <div class="table-cell">
                                        <div class="zoom-icon">
                                            <a class="lightbox" href="static/assets/frontend/img/portfolio/img-2.jpg"><i class="lni-zoom-in item-icon"></i></a>
                                        </div>
                                        <a href="#">View Project</a>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 col-xs-12 mix development">
                    <div class="portfolio-item">
                        <div class="shot-item">
                            <img src="static/assets/frontend/img/portfolio/img-3.jpg" alt="" />
                            <div class="single-content">
                                <div class="fancy-table">
                                    <div class="table-cell">
                                        <div class="zoom-icon">
                                            <a class="lightbox" href="static/assets/frontend/img/portfolio/img-3.jpg"><i class="lni-zoom-in item-icon"></i></a>
                                        </div>
                                        <a href="#">View Project</a>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 col-xs-12 mix development design">
                    <div class="portfolio-item">
                        <div class="shot-item">
                            <img src="static/assets/frontend/img/portfolio/img-4.jpg" alt="" />
                            <div class="single-content">
                                <div class="fancy-table">
                                    <div class="table-cell">
                                        <div class="zoom-icon">
                                            <a class="lightbox" href="static/assets/frontend/img/portfolio/img-4.jpg"><i class="lni-zoom-in item-icon"></i></a>
                                        </div>
                                        <a href="#">View Project</a>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 col-xs-12 mix development">
                    <div class="portfolio-item">
                        <div class="shot-item">
                            <img src="static/assets/frontend/img/portfolio/img-5.jpg" alt="" />
                            <div class="single-content">
                                <div class="fancy-table">
                                    <div class="table-cell">
                                        <div class="zoom-icon">
                                            <a class="lightbox" href="static/assets/frontend/img/portfolio/img-5.jpg"><i class="lni-zoom-in item-icon"></i></a>
                                        </div>
                                        <a href="#">View Project</a>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 col-xs-12 mix print design">
                    <div class="portfolio-item">
                        <div class="shot-item">
                            <img src="static/assets/frontend/img/portfolio/img-6.jpg" alt="" />
                            <div class="single-content">
                                <div class="fancy-table">
                                    <div class="table-cell">
                                        <div class="zoom-icon">
                                            <a class="lightbox" href="static/assets/frontend/img/portfolio/img-6.jpg"><i class="lni-zoom-in item-icon"></i></a>
                                        </div>
                                        <a href="#">View Project</a>
                                    </div>
                                </div>
                    ...
                    <div id="testimonials" class="touch-slider owl-carousel">
                        <div class="item">
                            <div class="testimonial-item">
                                <div class="author">
                                    <div class="img-thumb">
                                        <img src="static/assets/frontend/img/testimonial/img1.jpg" alt="">
                                    </div>
                        ...
                        <div class="item">
                            <div class="testimonial-item">
                                <div class="author">
                                    <div class="img-thumb">
                                        <img src="static/assets/frontend/img/testimonial/img2.jpg" alt="">
                                    </div>
                                    <div class="author-info">
                        ...
                        <div class="item">
                            <div class="testimonial-item">
                                <div class="author">
                                    <div class="img-thumb">
                                        <img src="static/assets/frontend/img/testimonial/img3.jpg" alt="">
                                    </div>
                                    <div class="author-info">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-xs-12">
                    <div class="single-team">
                        <img src="static/assets/frontend/img/team/team1.png" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-xs-12">
                    <div class="single-team">
                        <img src="static/assets/frontend/img/team/team2.png" alt="">
                        <div class="team-details">
                            <div class="team-inner">
                ...
                <div class="col-lg-3 col-md-6 col-xs-12">
                    <div class="single-team">
                        <img src="static/assets/frontend/img/team/team3.png" alt="">
                        <div class="team-details">
                            <div class="team-inner">
                ...
                <div class="col-lg-3 col-md-6 col-xs-12">
                    <div class="single-team">
                        <img src="static/assets/frontend/img/team/team4.png" alt="">
                        <div class="team-details">
                            <div class="team-inner">
            ...
            <div class="row">
                    ...
                    <div class="blog-item-wrapper">
                        <div class="blog-item-img">
                            <a href="single-post.html">
                                <img src="static/assets/frontend/img/blog/img1.jpg" alt="">
                            </a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-xs-12 blog-item">
                    ...
                    <div class="blog-item-wrapper">
                        <div class="blog-item-img">
                            <a href="single-post.html">
                                <img src="static/assets/frontend/img/blog/img2.jpg" alt="">
                            </a>
                        </div>
                        <div class="blog-item-text">
                            <div class="date"><i class="lni-calendar"></i>10 April, 2018</div>
                ...
                <div class="col-lg-4 col-md-6 col-xs-12 blog-item">
                    ...
                    <div class="blog-item-wrapper">
                        <div class="blog-item-img">
                            <a href="single-post.html">
                                <img src="static/assets/frontend/img/blog/img3.jpg" alt="">
                            </a>
                        </div>
                        <div class="blog-item-text">
                            <div class="date"><i class="lni-calendar"></i>10 April, 2018</div>
        ...
        <div class="container">
            ...
            <div class="row" id="clients-scroller">
                <div class="client-item-wrapper">
                    <img src="static/assets/frontend/img/clients/img1.png" alt="">
                </div>
                <div class="client-item-wrapper">
                    <img src="static/assets/frontend/img/clients/img2.png" alt="">
                </div>
                <div class="client-item-wrapper">
                    <img src="static/assets/frontend/img/clients/img3.png" alt="">
                </div>
                <div class="client-item-wrapper">
                    <img src="static/assets/frontend/img/clients/img4.png" alt="">
                </div>
                <div class="client-item-wrapper">
                    <img src="static/assets/frontend/img/clients/img5.png" alt="">
                </div>
                <div class="client-item-wrapper">
                    <img src="static/assets/frontend/img/clients/img6.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 padding-0">
                    <object style="border:0; height: 450px; width: 100%;" data="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15854.991478516928!2d106.7375727171596!3d-6.553481924160897!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69c4a20534f649%3A0xd1776f510c54cce1!2sSitugede%2C+Kec.+Bogor+Bar.%2C+Kota+Bogor%2C+Jawa+Barat!5e0!3m2!1sid!2sid!4v1561990496695!5m2!1sid!2sid"></object>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                        <div class="widget">
                            ...
                            <ul class="instagram-footer">
                                <li>
                                    <a href="#"><img src="static/assets/frontend/img/instagram/insta1.jpg" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="static/assets/frontend/img/instagram/insta2.jpg" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="static/assets/frontend/img/instagram/insta3.jpg" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="static/assets/frontend/img/instagram/insta4.jpg" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="static/assets/frontend/img/instagram/insta5.jpg" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="static/assets/frontend/img/instagram/insta6.jpg" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <script src="static/assets/frontend/js/jquery-min.js"></script>
    <script src="static/assets/frontend/js/popper.min.js"></script>
    <script src="static/assets/frontend/js/bootstrap.min.js"></script>
    <script src="static/assets/frontend/js/classie.js"></script>
    <!-- <script src="static/assets/frontend/js/color-switcher.js"></script> -->
    <script src="static/assets/frontend/js/jquery.mixitup.js"></script>
    <script src="static/assets/frontend/js/nivo-lightbox.js"></script>
    <script src="static/assets/frontend/js/owl.carousel.js"></script>
    <script src="static/assets/frontend/js/jquery.stellar.min.js"></script>
    <script src="static/assets/frontend/js/jquery.nav.js"></script>
    <script src="static/assets/frontend/js/scrolling-nav.js"></script>
    <script src="static/assets/frontend/js/jquery.easing.min.js"></script>
    <script src="static/assets/frontend/js/wow.js"></script>
    <script src="static/assets/frontend/js/jquery.vide.js"></script>
    <script src="static/assets/frontend/js/jquery.counterup.min.js"></script>
    <script src="static/assets/frontend/js/jquery.magnific-popup.min.js"></script>
    <script src="static/assets/frontend/js/waypoints.min.js"></script>
